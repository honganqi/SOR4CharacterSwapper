...
namespace SOR4_Replacer
{
    public partial class SwapListLevelPanel : Form
    {
        ...
        Library classlib;
        public SwapListLevelPanel(MainWindow mainwindow)
        {
            InitializeComponent();
        ...
        {
            classlib.FilterSwapTable("level", "origName", txtFilterOrig.Text);
        }

        private void txtFilterReplace_TextChanged(object sender, EventArgs e)
        {
            classlib.FilterSwapTable("level", "replaceName", txtFilterReplace.Text);
        }
