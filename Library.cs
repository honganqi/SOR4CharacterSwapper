...
namespace SOR4_Swapper
{
    public class Library
    {
        ...
        public static Dictionary<int, Character> characterDictionary = new()
        {
            ...
            [78] = new Character { Name = "Ms. Whatever (elite)", Path = "characters/sor4_enemies/msy/chrsor4msy_12survival_2_elite", Thumbnail = "animatedsprites/sor4/enemies/msy/sprsor4msyv3", NameIndex = "CHR_MSKNOWWHY", CustomNameIndex = "CHR_MSKNOWWHY_ELITE", IsPlayable = false, IsBoss = false, ReplaceRegs = true, ReplacedByRegs = true, IsMiniboss = true, IsRegularPlus = false, IsExcluded = false },
            ...
            [200] = new Character { Name = "Big Ben SOR2", Path = "characters/sor2_enemies/chrsor2bigben", Thumbnail = "animatedsprites/sor2/enemies/sprsor2bigben", NameIndex = "CHR_BIGBEN", CustomNameIndex = "CHR_SOR2_BIGBEN", IsPlayable = false, IsBoss = false, ReplaceRegs = true, ReplacedByRegs = true, IsMiniboss = false, IsRegularPlus = true, IsExcluded = false },
            ...
            [266] = new Character { Name = "Zamza", Path = "characters/sor2_enemies/chrsor2zamza", Thumbnail = "animatedsprites/sor2/enemies/sprsor2zamza", NameIndex = "CHR_ZAMZA", CustomNameIndex = "CHR_ZAMZA_NEW", IsPlayable = false, IsBoss = false, ReplaceRegs = false, ReplacedByRegs = true, IsMiniboss = true, IsRegularPlus = false, IsExcluded = false },
            [267] = new Character { Name = "Yamato (cursed)", Path = "characters/sor3_enemies/chrsor3yamato_cursed", Thumbnail = "animatedsprites/sor3/enemies/sprsor3yamato", NameIndex = "CHR_SOR3_YAMATO", CustomNameIndex = "CHR_SOR3_YAMATO_CURSED", IsPlayable = false, IsBoss = false, ReplaceRegs = true, ReplacedByRegs = true, IsMiniboss = true, IsRegularPlus = false, IsExcluded = false },
            [268] = new Character { Name = "Diva (reinforcement)", Path = "characters/sor4_enemies/diva/chrsor4diva_reinforcement", Thumbnail = "animatedsprites/sor4/enemies/diva/sprsor4diva", NameIndex = "CHR_DIVA", CustomNameIndex = "CHR_DIVA_REINFORCEMENT", IsPlayable = false, IsBoss = false, ReplaceRegs = true, ReplacedByRegs = true, IsMiniboss = false, IsRegularPlus = true, IsExcluded = false },
        };
